...
export default class Dress1 extends Phaser.State {
    ...
    public create(): void {
        ...
        this.chest = new Chest(this, 700)
            ...
            .page()
                ...
                .item(525, 120, 'dress9',
                    ...
                    this.onItem)
                .item(586, 121, 'dress10',
                    ImageUtils.getAtlasClass('AtlasesStateDress1').getName(),
                    ImageUtils.getAtlasClass('AtlasesStateDress1').Frames.Dress10,
                    this.onItem)
                .item(655, 121, 'dress11',
                    ImageUtils.getAtlasClass('AtlasesStateDress1').getName(),
                    ImageUtils.getAtlasClass('AtlasesStateDress1').Frames.Dress11,
                    this.onItem)
                .item(719, 120, 'dress12',
                    ImageUtils.getAtlasClass('AtlasesStateDress1').getName(),
                    ImageUtils.getAtlasClass('AtlasesStateDress1').Frames.Dress12,
                    this.onItem)
                .item(814, 125, 'dress13',
                    ImageUtils.getAtlasClass('AtlasesStateDress1').getName(),
                    ImageUtils.getAtlasClass('AtlasesStateDress1').Frames.Dress13,
                    this.onItem)
            .build()
            .static()
                .item(367, 539, 'shoe1',
                ...
                .item(702, 549, 'shoe5',
                    ...
                    this.onItem)
                .animatedItem(696, 382, 'mmmm',
                    ImageUtils.getSpritesheetClass('SpritesheetsMmmm1451584').getName(),
                    [1, 2, 3, 4], 5, true,
                ...
                .compoundItem(7, 1, 7, 564, 350, 'jew',
                    ...
                    this.onItem)
                .compoundItem(6, 1, -1, 415, 331, 'hair',
                    ImageUtils.getAtlasClass('AtlasesStateDress1').getName(),
        ...
        // Dolls
        this.doll = new Doll(this, 128, 47)
            .layer(41, 0, 'hair_b',
                'AtlasesDollAriel',
                'HB', 'HB')
            .layer(0, 71, 'body',
