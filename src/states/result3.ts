...
export default class Result3 extends Phaser.State {
    ...
    public create(): void {
        ...
        this.bg = this.game.add.sprite(23, 73, ImageUtils.getImageClass('ImagesBg7').getName());
        this.container.add(this.bg);

        this.container.add(GameConfig.DOLL_3.getBody());
        GameConfig.DOLL_3.setPosition(103, 314);
        GameConfig.DOLL_3.setScale(.73);
        ...
        const p1 = this.game.add.sprite(503 + 500, 146,
            ImageUtils.getAtlasClass('AtlasesStateResult3').getName(),
            ImageUtils.getAtlasClass('AtlasesStateResult3').Frames.Post1,
            this.container
        );
        const p2 = this.game.add.sprite(503 + 500, 216,
            ImageUtils.getAtlasClass('AtlasesStateResult3').getName(),
            ImageUtils.getAtlasClass('AtlasesStateResult3').Frames.Post2,
            this.container
        );
        const p3 = this.game.add.sprite(503 + 500, 286,
            ImageUtils.getAtlasClass('AtlasesStateResult3').getName(),
            ImageUtils.getAtlasClass('AtlasesStateResult3').Frames.Post3,
            this.container
        );
        const p4 = this.game.add.sprite(503 + 500, 355,
            ImageUtils.getAtlasClass('AtlasesStateResult3').getName(),
            ImageUtils.getAtlasClass('AtlasesStateResult3').Frames.Post4,
            this.container
        );
        const p5 = this.game.add.sprite(503 + 500, 425,
            ImageUtils.getAtlasClass('AtlasesStateResult3').getName(),
            ImageUtils.getAtlasClass('AtlasesStateResult3').Frames.Post5,
            this.container
        );
        const p6 = this.game.add.sprite(503 + 500, 495,
            ImageUtils.getAtlasClass('AtlasesStateResult3').getName(),
            ImageUtils.getAtlasClass('AtlasesStateResult3').Frames.Post6,
            this.container
        );
    ...
    public shutdown(): void {
        ...
        GameConfig.CONT_3 = this.container;
