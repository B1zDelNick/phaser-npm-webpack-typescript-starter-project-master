...
export default class Dress2 extends Phaser.State {
    ...
    public create(): void {
        ...
        // Dolls
        this.doll = new Doll(this, 43, 4)
            .layer(0, 0, 'hair_b',
                ImageUtils.getAtlasClass('AtlasesDollRapHairsB').getName(),
                ImageUtils.getAtlasClass('AtlasesDollRapHairsB').Frames,
                'HB', 'HB')
            .layer(0, 0, 'dress_b',
                ImageUtils.getAtlasClass('AtlasesDollRapDressesB').getName(),
                ImageUtils.getAtlasClass('AtlasesDollRapDressesB').Frames,
                'DB', null)
            .layer(0, 0, 'bag',
            ...
            .layer(0, 0, 'dress_f',
                ...
                ImageUtils.getAtlasClass('AtlasesDollRapDressesF').Frames,
                'DF', null)
            .layer(0, 0, 'hair',
                ImageUtils.getAtlasClass('AtlasesDollRapHairs').getName(),
                ImageUtils.getAtlasClass('AtlasesDollRapHairs').Frames,
                'H', 'H')
            .layer(0, 0, 'hat',
                ImageUtils.getAtlasClass('AtlasesDollRap').getName(),
                ImageUtils.getAtlasClass('AtlasesDollRap').Frames,
    ...
    private nextState(): void {
        ...
        this.chest.disable();
        this.chest.hide();
        TweenUtils.move(this.doll.getBody(), 275, this.doll.getBody().y, Phaser.Timer.SECOND * 1);
